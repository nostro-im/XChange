...
import org.knowm.xchange.binancemargin.dto.meta.BinanceCurrencyPairMetaData;
  ...
  public long deltaServerTime() throws IOException {
    ...
    if (deltaServerTime == null || deltaServerTimeExpire <= System.currentTimeMillis()) {
      ...
      Binancemargin binance =
          RestProxyFactory.createProxy(Binancemargin.class, getExchangeSpecification().getSslUri());
