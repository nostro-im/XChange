...
public class BinanceAdapters {
  ...
  public static Order adaptOrder(BinanceOrder order) {
    ...
    if (order.type.equals(org.knowm.xchange.binance_margin.dto.trade.OrderType.MARKET)) {
      builder = new MarketOrder.Builder(type, currencyPair);
    } else if (order.type.equals(org.knowm.xchange.binance_margin.dto.trade.OrderType.LIMIT)
        || order.type.equals(org.knowm.xchange.binance_margin.dto.trade.OrderType.LIMIT_MAKER)) {
