...
public class BinanceUserDataStreamingService extends JsonNettyStreamingService {
  ...
  public static BinanceUserDataStreamingService create(String userApiBaseUri, String listenKey) {
    return new BinanceUserDataStreamingService(userApiBaseUri + listenKey);
  }
